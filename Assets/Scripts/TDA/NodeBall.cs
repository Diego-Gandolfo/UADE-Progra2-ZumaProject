...
{
    public IBall element; // Este es el elemento del Nodo, en nuestro caso son los Spheres quiero ver si esto funciona, sino lo simplifico a que funcione solo con Spheres y listo!
    ...
    public void InitializeNode(IBall element, NodeBall previousNode, NodeBall nextNode) // Para inicializar todos los datos del nodo
    {
